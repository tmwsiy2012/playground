...
xlsxout.writeAnnualAreaDataExcelFile(CONST_EXCEL_FILE,CONST_AREA,CONST_YEAR)
workbook = xlrd.open_workbook(CONST_EXCEL_FILE)
...
for sc in suppressed_codes:
    sibling_sum = isNoBrainerAnnualSum(suppressed_codes,'37021','2012',sc)
    if sibling_sum > 0:
        print(sc)
